          ...
          <div class="item item-1">
            <div class="img-fill">
                <div class="text-content">
                  <h6>SELF DRIVE CARS IN WARANGAL</h6>
                  <h4>CAR ON RENT  <br> IN WARANGAL</h4>
          ...
          <div class="item item-2">
            <div class="img-fill">
                <div class="text-content">
                  h6>SELF DRIVE CARS IN WARANGAL</h6>
                  <h4>CAR ON RENT  <br> IN WARANGAL</h4>
                  <p>In addition to being the Tri City, Warangal is a cosmopolitan city with people from all over the country, and ready to embrace an evolving lifestyle</p>
          ...
          <div class="row">
            ...
            <div class="col-md-6 align-self-center">
              <div class="right-content">
                ...
                <p>We Are Students Pursing Bachelors's of Technology (BTECH) At KAKATIYA UNIVERSITY COLLEGE OF ENGINERRING AND TECHNOLOGY </p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3 footer-item">
            <h4> CARRENTAL.com</h4>
            <p>With flexible rental options in Warangal, renting from CARRENTAL.com has become the preferred choice for most Warangal locals.</p>
          ...
          <div class="col-md-3 footer-item">
            ...
            <ul class="menu-list">
              ...
              <li><a href="team.jsp">Pasunoori Koushik</a></li>
